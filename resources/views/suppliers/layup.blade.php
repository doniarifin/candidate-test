  ...
  >
      ...
      <div class="bg-white rounded-xl shadow p-6">
              ...
              <div>
                  <h1 class="text-2xl font-bold text-gray-800">
                      ...
                      <span class="ml-2 px-2 py-1 text-xs rounded-full"
                          :class="statusClass(layup.status)"
                          x-text="statusLabel(layup.status)">
                      </span>
                  </h1>
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 text-sm">
              <div class="p-4 border rounded-lg">
                  ...
                  <p class="font-medium" x-text="layup.created_by ?? '-'"></p>
              </div>

              <div class="p-4 border rounded-lg">
                  <p class="text-gray-400">LAST MODIFIED</p>
                  <p class="font-medium" x-text="$helper.formatDate(layup.updated_at)"></p>
              </div>

              <div class="p-4 border rounded-lg">
                  <p class="text-gray-400">TOTAL THICKNESS</p>
                  <p class="font-bold text-green-600" x-text="totalThickness + ' mm'"></p>
              </div>

              <div class="p-4 border rounded-lg">
                  <p class="text-gray-400">TOTAL LAYERS</p>
                  <p class="font-bold text-green-600" x-text="layers.length + ' Layers'"></p>
              </div>
          </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div class="lg:col-span-2 bg-white rounded-xl shadow p-6">
              ...
              <!-- EMPTY -->
              <div x-show="!loading && layers.length === 0"
